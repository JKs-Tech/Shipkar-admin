...
class ConfigController extends Controller
{
    ...
    public function configuration()
    {
        ...
        return response()->json([
            ...
            'base_urls' => [
                'item_image_url' => asset('storage/app/product'),
                ...
                'store_image_url' => asset('storage/app/store'),
                'vendor_image_url' => asset('storage/app/vendor'),
                'store_cover_photo_url' => asset('storage/app/store/cover'),
                ...
                'module_image_url' => asset('storage/app/module'),
                'parcel_category_image_url' => asset('storage/app/parcel_category'),
