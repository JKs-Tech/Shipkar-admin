                    ...
                    <div class="card">
                        ...
                        <div class="card-body d-flex flex-column pt-0">
                            <div class="text-center my-auto py-4 py-xl-5">
                                ...
                                src="{{\App\CentralLogics\Helpers::onerror_image_helper($shop->logo, asset('storage/app/store/').'/'.$shop->logo, asset('public/assets/admin/img/image-place-holder.png'), 'store/') }}" alt="Product thumbnail"/>
                            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body d-flex flex-column pt-0">
                            <div class="text-center my-auto py-4 py-xl-5">
                                ...
                                src="{{\App\CentralLogics\Helpers::onerror_image_helper($shop->cover_photo, asset('storage/app/store/cover/').'/'.$shop->cover_photo, asset('public/assets/admin/img/restaurant_cover.jpg'), 'store/cover/') }}" alt="Product thumbnail"/>
                            </div>
                            <div class="custom-file">
