                    ...
                    <div class="card mb-3 mb-lg-5" id="generalDiv">
                        ...
                        <label
                            ...
                            <img id="viewer"
                                 ...
                                 src="{{\App\CentralLogics\Helpers::onerror_image_helper($data->image, asset('storage/app/seller/').'/'.$data->image, asset('public/assets/back-end/img/160x160/img1.jpg'), 'seller/') }}"
                                 alt="Image">
                        </label>
                        <!-- End Avatar -->
                    </div>
