        ...
        @foreach($top_sell as $key=>$item)
            <div class="col-md-4 col-sm-6 initial--27 redirect-url"
                ...
                <div class="grid-card">
                    ...
                    src="{{\App\CentralLogics\Helpers::onerror_image_helper($item['image'], asset('storage/app/product/').'/'.$item['image'], asset('public/assets/admin/img/placeholder-2.png'), 'product/') }}"
