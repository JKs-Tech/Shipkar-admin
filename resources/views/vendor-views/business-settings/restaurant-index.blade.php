                                        ...
                                        <label class="__custom-upload-img mr-lg-5">
                                            ...
                                            <div class="text-center">
                                                <img class="img--110 min-height-170px min-width-170px onerror-image" id="viewer"
                                                     ...
                                                     src="{{\App\CentralLogics\Helpers::onerror_image_helper($store->meta_image, asset('storage/app/store').'/'.$store->meta_image, asset('public/assets/admin/img/upload.png'), 'store/') }}"
