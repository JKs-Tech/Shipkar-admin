            ...
            <div class="row align-items-center py-2">
                <div class="col-sm mb-2 mb-sm-0">
                    <div class="d-flex align-items-center">
                        <img class="onerror-image" data-onerror-image="{{asset('/assets/admin/img/eshop.svg')}}"src="{{\App\CentralLogics\Helpers::onerror_image_helper($mod->icon, asset('storage/app/module/').'/'.$mod->icon, asset('public/assets/admin/img/eshop.svg'), 'module/') }}"
                        width="38" alt="img">
